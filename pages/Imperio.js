...
const Imperio = () => {
  ...
  const meuDicionario = {
    'Darth Vader': require('../img/darthvader.jpeg'),
  ...
  if (imageSource) {
    return (
      <View style={styles.item}>
        <Image source={imageSource} style={{ width: 350, height: 350, margin: 5, borderRadius: 30 }} />
    ...
    <View style={styles.container}>
      <ScrollView>
        <View style={styles.box_imperio}>
          <View style={{ flex: 1 }}>
            <Text style={styles.text}>Império</Text>
          </View>
          <View style={styles.text_imperio}>
            <Text style={styles.text_imperio}>
              O Império Galáctico em Star Wars é uma ditadura liderada pelo
              Imperador Palpatine (Darth Sidious). Surgiu após a queda da
              República, usando forças armadas e tecnologia militar avançada
              para impor seu domínio sobre a galáxia. Isso desencadeou uma saga
              de conflito entre o lado sombrio e a luz.
            </Text>
          </View>
        </View>
